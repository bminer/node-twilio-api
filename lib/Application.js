...
Application.prototype._getResourceURI = function(type) {
	return this._account._getResourceURI() + '/Applications/' + this.Sid;
}
...
Application.prototype.register = function() {
	...
	{
		this._client._appMiddleware[this.Sid] = this;
...
Application.prototype.unregister = function() {
	if(this._client._appMiddleware[this.Sid] != undefined)
	{
		var index = this._client.appMiddlewareSids.indexOf(this.Sid);
		this._client.appMiddlewareSids.slice(index, 1);
