...
Call.prototype.liveRedirect = function(url, method) {
	this.Url = url;
	this.Method = method;
	this.save(cb);
	delete this.Url;
...
Call.prototype.cb = function(cb) {
	this._cb[this._cbID] = cb;
	this.redirect(this._app.VoiceUrl + "?cbtype=cb&cb=" + encodeURIComponent(this._cbID), this._app.VoiceMethod);
	this._cbID++;
}
/* TwiML <Say> Verb */
...
Call.prototype.gather = function(cbIfInput, options, cbIfNoInput) {
	...
	gather.twiml
		.setAttribute('action', this._app.VoiceUrl + "?cbtype=gather&cb=" + encodeURIComponent(this._cbID) )
...
Call.prototype.record = function(cb, options, cbIfEmptyRecording) {
	...
	record
		.setAttribute('action', this._app.VoiceUrl + "?cbtype=record&cb=" + encodeURIComponent(this._cbID) )
		.setAttribute('method', this._app.VoiceMethod)
		.setAttribute('timeout', options.timeout)
...
/*Call.prototype.dial = function(callees, options, cbAfterDial) {
	...
	dial
		.setAttribute('action', this._app.VoiceUrl + "?cbtype=dial&cb=" + encodeURIComponent(this._cbID) )
		.setAttribute('method', this._app.VoiceMethod)
		.setAttribute('timeout', options.timeout)
...
Call.prototype.joinConference = function(roomName, options, cbOnEnd) {
	...
	if(typeof cbOnEnd == "function")
	{
		...
		dial.setAttribute('action', this._app.VoiceUrl + "?cbtype=dial&cb=" + encodeURIComponent(this._cbID) )
			.setAttribute('method', this._app.VoiceMethod);
		this._cbID++;
