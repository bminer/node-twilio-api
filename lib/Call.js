...
Call.prototype.cb = function(cb) {
	...
	this.redirect(this._app.VoiceUrl + "?cb=" + encodeURIComponent(this._cbID), this._app.VoiceMethod);
	this._cbID++;
}
/* TwiML <Say> Verb */
...
Call.prototype.gather = function(cbIfInput, options, cbIfNoInput) {
	...
	gather.twiml
		.setAttribute('action', this._app.VoiceUrl + "?cb=" + encodeURIComponent(this._cbID) )
