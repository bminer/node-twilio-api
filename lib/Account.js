...
Account.prototype._getResourceURI = function(type) {
	return this._client._getResourceURI() + '/Accounts/' + this.Sid;
}
...
Client.prototype.createApplication = function(appInfo, cb) {
	...
	{
		cli._restAPI('POST', "Accounts/" + cli.accountSID + "/Applications", appInfo, function(err, res) {
			if(err) cb(err);
			else
			{
...
Client.prototype.getApplication = function(appSID, cb) {
	var cli = this;
	cli._restAPI('GET', "Accounts/" + cli.accountSID + "/Applications/" + appSID, function(err, res) {
